var PU_Size = cc.Class.extend({
    ...
    ctor:function (gameLayer, posicion) {
        ...
        this.sprite = new cc.PhysicsSprite("#pu_size_1.png");
        ...
        this.shape = new cp.BoxShape(this.body,
            this.sprite.getContentSize().width+50 ,
            this.sprite.getContentSize().height+50);
